...
countD = tf.feature_column.numeric_column("countD")
countN = tf.feature_column.numeric_column("countN")
group = tf.feature_column.categorical_column_with_vocabulary_list("group",['0','1'])
cross_column = [tf.feature_column.crossed_column(
    ['countD', 'countN'], hash_bucket_size=1000)]
base_columns = [countD,countN]
label_column = [group]
...
def build_estimator(model_dir, model_type):
  ...
  model_dir=model_dir, feature_columns=base_columns+ cross_column)
  return m
